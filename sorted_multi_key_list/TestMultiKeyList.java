...
public class TestMultiKeyList
{
    ...
    public static void main(String[] args)
    {
        ...
        A  = new MyMultiKeyList(3);
        keys =  new Comparable[3];
        
        
        keys[0] = new Integer(2);
        keys[1] = "DOG";
        keys[2] = new Integer(7);
        A.add(keys,  "Object4");
        
        keys[0] = new Integer(1);
        keys[1] = "ACT";
        keys[2] = new Integer(5);
        A.add(keys, "Object1");
        
        keys[0] = new Integer(3);
        keys[1] = "BOB";
        keys[2] = new Integer(2);
        A.add(keys,  "Object2");
        ...
        keys[0] = new Integer(4);
        keys[1] = "EEE";
        keys[2] = new Integer(23445);
        A.add(keys,  "Object6");
        ...
        Comparable[] b = new Comparable[]{new Integer(2), "DOG", new Integer(7)};

        //System.out.println(keys[0].equals(b[0]));
        
        A.remove("CAT", 1);
        
        MultiKeyListIterator it = A.iterator(1);
